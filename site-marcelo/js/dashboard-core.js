...
class DashboardCore {
    ...
    updateOverview() {
        ...
        document.querySelector('[data-stat="available"]').textContent = stats.available;
        document.querySelector('[data-stat="sold"]').textContent = stats.sold;
        document.querySelector('[data-stat="revenue"]').textContent = this.formatCurrency(stats.revenue);
